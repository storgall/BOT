        ...
        room: {
            ...
            roulette: {
                ...
                endRoulette: function() {
                    ...
                    var array_id = "";
                    for (var koko = 0; koko < basicBot.room.roulette.participants.length; koko++){
                        var array_id += basicBot.room.roulette.participants[koko].id+", ";
                    }
            ...
            ballCommand: {
                ...
                functionality: function(chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void(0);
                        ...
                        if (argument.toLowerCase() == "je tu bot?" || argument.toLowerCase() == "bote jsi tu?" || argument.toLowerCase() == "je tu bot ?" || argument.toLowerCase() == "bote jsi tu ?") {
                        ...
                        } else if (argument.toLowerCase() == "roulette" || argument.toLowerCase() == "kdy bude ruleta" || argument.toLowerCase() == "kdy bude ruleta?" || argument.toLowerCase() == "roulette?" || argument.toLowerCase() == "kdy bude ruleta ?") {
                            ...
                            API.sendChat(subChat("\/me Maximální délka písničky je " + Math.round(Math.floor(basicBot.settings.maximumSongLength)) + " minut a " + Math.round(Math.floor(60*(basicBot.settings.maximumSongLength-Math.round(Math.floor(basicBot.settings.maximumSongLength))))) + " sekund"));
                        } else {
